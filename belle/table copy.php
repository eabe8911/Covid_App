...
<body>
    ...
    <div id="table" class="collapse" aria-labelledby="headingOne">
        <div class="card card-body">
            ...
            search_table3("SELECT uuid, cname, fname, userid, testtype,sampleid1, sampleid2, apdat, tdat, ftest, pcrtest, fpdfflag, pcrpdfflag, frptflag, qrptflag from libodb.covid_trans
    ...
    <div id="table1" class="collapse" aria-labelledby="headingTwo">
        <div class="card card-body">
            ...
            search_table4("SELECT uuid, cname, fname, userid, testtype,sampleid1, sampleid2, apdat, tdat, ftest, pcrtest, fpdfflag, pcrpdfflag, frptflag, qrptflag from libodb.covid_trans
