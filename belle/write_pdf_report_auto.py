...
if nationality!="":
    ...
    #can.drawString(14.5*cm, 24.2*cm, now) #20220830 olive check new japan report
    #English name
    can.drawString(4.5*cm, 22.5*cm, fname) #20220830 olive check new japan report
    #can.drawString(4.5*cm, 23*cm, fname) #20220830 olive check new japan report
    #PassportID
    # can.drawString(12*cm, 23*cm, passportid) #20220830 olive check new japan report


    ##################################### Need to be modified
    #Nationality
    # can.drawString(5.3*cm, 22.1*cm, "Nationality")
    #can.drawString(5.3*cm, 22.1*cm, nationality) #20220830 olive check new japan report
    #####################################
    ...
    #can.drawString(10.5*cm, 22.1*cm, dob) #20220830 olive check new japan report
    #Sex
    # sex = sex.split('/')[-1].strip()
    # can.drawString(14.0*cm, 22.1*cm, sex) #20220830 olive check new japan report
    #Institution
    can.drawString(11.0*cm, 3.8*cm, "Lihpao Medical Laboratory") #20220830 olive check new japan report
    #can.drawString(11.0*cm, 4.3*cm, "Lihpao Medical Laboratory") #20220830 olive check new japan report
    #address of the institution
    size = 8
    can.setFont(font, size)
    # can.drawString(11.0*cm, 3.7*cm, "7F., No. 137, Sec. 2, Jianguo N. Rd., Zhongshan Dist.,")#20220830 olive check new japan report
    # can.drawString(11.0*cm, 3.3*cm, "Taipei City 104, Taiwan (R.O.C.)")#20220830 olive check new japan report

    #modify the location of input picture #20220830 olive check new japan report
    ...
    #can2.drawString(1.55*cm, 16.9*cm, "✓") #20220830 olive check new japan report
    #can2.drawString(5.55*cm, 16.9*cm, "✓") #20220830 olive check new japan report
    #pcrtest
    ...
    # if pcrtest.lower() == 'negative':
    #     can2.drawString(12.3*cm, 16.9*cm, "✓") #20220830 olive check new japan report
    # elif pcrtest.lower() == 'positive':
    #     can2.drawString(12.3*cm, 15.65*cm, "✓") #20220830 olive check new japan report
    else:
    ...
    #rdat #20220830 olive check new japan report
    ...
    if int(tdat_hour) >= 12:
        ...
        # can2.drawString(16.5*cm, 13.45*cm, tdat_hour) #20220830 olive check new japan report
        # can2.drawString(17.1*cm, 13.45*cm, tdat_min) #20220830 olive check new japan report
        size = 22
        can2.setFont("Courier", size)
        can.setFont('Courier-Bold', 10)
        can2.drawString(15.9*cm, 14.3*cm, "O")
        # can2.drawString(15.9*cm, 13.35*cm, "O") #20220830 olive check new japan report
    else:
        can2.drawString(16.6*cm, 14.3*cm, tdat_hour)
        can2.drawString(17.2*cm, 14.3*cm, tdat_min)
        # can2.drawString(16.5*cm, 13.45*cm, tdat_hour) #20220830 olive check new japan report
        ...
        #can2.drawString(15.42*cm, 13.35*cm, "O") #20220830 olive check new japan report
    can2.showPage()
    can2.save()
