...
<body>
    ...
    <div class="row flex-nowrap">
            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <div>
                    ...
                    <input style="margin:1em;" type="button" class="btn btn-secondary"
                        onclick="window.location.href='menu.php'" value="回首頁">
        ...
        <div class="col py-3" style="margin:1em;">
            ...
            <div>
                <form method="post" action="import_file_winform_auto.php" enctype="multipart/form-data" target="_blank">
            ...
            <div>
                <form action=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> method="post"
                    ...
                    <div class="col-6 col-sm-3">
                        ...
                        <input type="date" name="zipfile_date" class="form-control"
                            onkeypress="if (window.event.keyCode==13) return false;" value="<?php echo $date; ?>">
                    </div>
                    <br>
                    <div class="col-auto">
