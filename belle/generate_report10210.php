...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["Generate_Report"]))
{
    ...
    $sql4 = "SELECT uuid,userid,sex,cname,fname,lname,dob,mobile,uemail,ftest,pcrtest,type,telephone,address2,testtype,passportid,sampleid1,sampleid2,residentpermit,vuser2,
...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["Search"])){
   ...
   //060921 add limit 1 to ensure always select the last row of uuid 
    if($tdat_err == "")
	{
		...
		$sql0 = "SELECT COUNT(*) FROM covid_trans WHERE 1=1 and apdat LIKE ? ";
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style='display:inline'>
            <div class="form-group">
                ...
                <input type="text":focus name="tdat" class="form-control <?php echo (!empty($tdat_err)) ? 'is-invalid' : ''; ?>" onkeypress="if (window.event.keyCode==13) return false;" value="<?php echo $tdat; ?>" tabindex=1>
			...
			<div class="form-group" style='display:inline'>
                ...
                <input type="text" name="apdatno"  class="form-control " value="<?php echo $total_appoint; ?>" readonly tabindex=11><br>
                <label>總報到人數</label>
                <input type="text" name="sampleno" class="form-control " value="<?php echo $total_sample; ?>" readonly tabindex=4>
				<label>完成檢測人數</label>
                <input type="text" name="tested" class="form-control " value="<?php echo $tested; ?>" readonly tabindex=5>
				<label>需發快篩報告人數</label>
                <input type="text" name="n_ftest" class="form-control " value="<?php echo $n_ftest; ?>" readonly tabindex=6>
				<label>已產生快篩報告人數</label>
                <input type="text" name="freported" class="form-control " value="<?php echo $freported; ?>" readonly tabindex=7>
				<label>需發PCR報告人數</label>
                <input type="text" name="n_pcrtest" class="form-control " value="<?php echo $n_pcrtest; ?>" readonly tabindex=8>
				<label>已產生PCR報告人數</label>
                <input type="text" name="pcrreported" class="form-control " value="<?php echo $pcrreported; ?>" readonly tabindex=9>
				<label>未產生報告人數</label>
                <input type="text" name="unreported" class="form-control " value="<?php echo $unreported; ?>" readonly tabindex=10>
