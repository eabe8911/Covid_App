    ...
    <div class="row flex-nowrap">
            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <div id="print_ckin">
                    <form action="../print_inspection.php" method="post">
                        <br>
                        &ensp;&ensp;&ensp;
                        <input id="printdiv" type="submit" class="btn btn-success" name="print" value="   列            印   " target="_blank">
                    </form>
                </div>


                <form id="form_checkin" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="display:inline;">
        ...
        <div class="col py-3">
            ...
            ?>
                ...
                <div class="col-auto">
                        <label>PCR ID / UUID</label>
                        <input type="text" id="pcrid_uuid" name="pcrid_uuid" class="form-control" value="<?php echo $pcrid_uuid; ?>">
                    </div>

                    <div class="col-auto">
                        <label>身分證號 / 護照號碼</label>
                        <input type="text" id="userid_passid" name="userid_passid" class="form-control" value="<?php echo $userid_passid; ?>">
                    </div>
                </div>
                <br>
                ...
                <div class="col-auto">
                    ...
                    <input type="submit" id="clear" name="clear" class="btn btn-success" value=" 清    除 ">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                ...
                <div id="read" class="row g-3">
                    ...
                    <div class="col-auto">
                        <label>PCR ID</label>
                        <input onchange="TesttypeCheck(this.value)" pattern="^F[0-9]{9}" type="text" :focus id="sampleid2" name="sampleid2" class="form-control" onkeypress="if (window.event.keyCode==13) return false;" value="<?php echo $sampleid2; ?>">
                    </div>
                    ...
                    <div class="col-auto">
                        <label>大陸專案</label>
                        <input type="text" id="xmappoint" name="xmappoint" class="form-control" value="<?php echo $xmappoint; ?>">
                    </div>
                ...
                <div class="col-auto">
                    ...
                    <div class="col-auto">
                        ...
                        <!-- <div  class="col-auto">
                            <select id="twrpturgency" name="twrpturgency" class="form-control">
                            <option value=""></option>
