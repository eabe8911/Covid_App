...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["save"])) {
	...
	$sql2 = "update covid_trans set cname= ?,fname=?,lname=?,
	...
	if ($stmt2 = mysqli_prepare($conn, $sql2)) {
		...
		$sql_comment = $_SESSION["username"] . ": update covid_trans set cname= {$p1},fname={$p2},lname={$p3},
...
// 			$sql3 = "update covid_trans set ftest= ?,pcrtest=?,vuser1=?,rdat = (select NOW() from dual) where uuid=?";
...
// 				$sql_comment = $_SESSION["username"] . ": update covid_trans set ftest={$p1},pcrtest={$p2},vuser1={$p3},rdat = (select NOW() from dual) where uuid={$p4}";
// 				write_sql($sql_comment, "BeanCode");
// 			}
// 			// Attempt to execute the prepared statement
...
// 			$sql4 = "update covid_trans set vuser2=?,frptflag=? where uuid=?";
...
// 				$sql_comment = $_SESSION["username"] . ": update covid_trans set vuser2={$p1},frptflag={$p2} where uuid=$p3}";
// 				write_sql($sql_comment, "BeanCode");
// 			}
			// echo "New record created successfully";
