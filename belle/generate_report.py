...
with open(sys.argv[1], 'r') as f:
    line1 = f.readline()
    line = f.readline()
    uuid,userid,sex,cname,fname,lname,dob,mobile,uemail,ftest,pcrtest,app_type,telephone,address2,testtype,passportid,sampleid1,sampleid2,residentpermit,vuser2,tdat,rdat,sendname,frptflag,qrptflag,hicardno,fpdfflag,pcrpdfflag,mtpid,xmrpturgency = line.split('\n')[0].split('\t')[:]
