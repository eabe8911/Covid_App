...
while True:
    ...
    cmd = '''SELECT uuid,userid,mtpid,sex,cname,fname,lname,dob,mobile,uemail,ftest,pcrtest,type,telephone,address2,testtype,
            passportid,sampleid1,sampleid2,residentpermit,vuser2,tdat,rdat,sendname,frptflag,qrptflag,hicardno,fpdfflag,pcrpdfflag,xmrpturgency
    ...
    for Infos in cursor.fetchall():
        try:
            uuid,userid,mtpid,sex,cname,fname,lname,dob,mobile,uemail,ftest,pcrtest,app_type,telephone,address2,testtype,passportid,sampleid1,sampleid2,residentpermit,vuser2,tdat,rdat,sendname,frptflag,qrptflag,hicardno,fpdfflag,pcrpdfflag,xmrpturgency = Infos[:]
