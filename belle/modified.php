        ...
        <div class="col py-3">
            ...
            ?>
                ...
                <div class="col-auto">
                    ...
                    <input type="submit" id="checkin_x" name="checkin_x" class="btn btn-success" value=" 報   到 ">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                ...
                <div id="read" class="row g-3">
                    ...
                    <div class="col-auto">
                        <label>送檢單位統一編號</label>
                      	<input type="text" id="sendname" name="sendname" class="form-control " value="<?php echo $sendname; ?>">

                        <div id="PointMsgSendname"></div>
                    </div>
  	  	    <div class="col-auto" hidden>
                        <label>收據編號</label>
                        <input type="text" id="xmapdat" class="form-control" name="xmapdat" value="<?php echo $xmapdat; ?>">
                    </div>
