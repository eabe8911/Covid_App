...
function update() {
    if (d3.select("#defaultCheck2").property("checked")) {
        ...
        document.getElementById('twrpturgency').removeAttribute('readonly');
        document.getElementById('save').removeAttribute('disabled');
        // document.getElementById('checkin_x').removeAttribute('disabled');
        document.getElementById('tdat').removeAttribute('readonly');
        // tdate = document.getElementById('tdat').value;
        // if ( document.getElementById('tdat').value == ""){
        //     document.getElementById('tdat').removeAttribute('readonly');
        // }
        ...
        d3.select("#twrpturgency").attr('readonly', true);
        d3.select("#save").attr('disabled', true);
        // d3.select("#checkin_x").attr('disabled', true);
