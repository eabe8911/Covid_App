...
function update() {
    if (d3.select("#defaultCheck2").property("checked")) {
        ...
        document.getElementById('xmappoint').removeAttribute('readonly');
        ...
        document.getElementById('xmrpturgency').removeAttribute('disabled');
        document.getElementById('testreason').removeAttribute('disabled');
        ...
        d3.select("#xmappoint").attr('readonly', true);
        ...
        d3.select("#xmrpturgency").attr('disabled', true);
        d3.select("#testreason").attr('disabled', true);
