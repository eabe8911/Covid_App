...
function update() {
    if (d3.select("#defaultCheck2").property("checked")) {
        ...
        document.getElementById('tdat').removeAttribute('readonly');
        ...
        document.getElementById('hicardno').removeAttribute('readonly');
        document.getElementById('sendname').removeAttribute('readonly');
        document.getElementById('companytitle').removeAttribute('readonly');
        document.getElementById('receiptid').removeAttribute('readonly');
        ...
        document.getElementById('mtpid').removeAttribute('readonly');
        document.getElementById('cancel').removeAttribute('disabled');

        document.getElementById('sex').removeAttribute('disabled');
        document.getElementById('payflag').removeAttribute('disabled');
        document.getElementById('twrpturgency').removeAttribute('disabled');
        document.getElementById('testtype').removeAttribute('disabled');
        ...
        d3.select("#tdat").attr('readonly', true);
        d3.select("#cname").attr('readonly', true);
        d3.select("#fname").attr('readonly', true);
        ...
        d3.select("#hicardno").attr('readonly', true);
        d3.select("#sendname").attr('readonly', true);
        d3.select("#companytitle").attr('readonly', true);
        d3.select("#sendno").attr('readonly', true);
        d3.select("#sampleid1").attr('readonly', true);
        d3.select("#memo").attr('readonly', true);

        d3.select("#sampleid2").attr('readonly', true);
        d3.select("#nationality").attr('readonly', true);
        d3.select("#mtpid").attr('readonly', true);
        d3.select("#receiptid").attr('readonly', true);

        d3.select("#cancel").attr('disabled', true);

        d3.select("#sex").attr('disabled', true);
        d3.select("#payflag").attr('disabled', true);
        d3.select("#twrpturgency").attr('disabled', true);
        d3.select("#testtype").attr('disabled', true);
