    ...
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0" style="background-color:#ffffe6;">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <div></div>
                <div>
                    <a style="margin:1em;" class="nav-link px-0"><h2><?php echo $search_result . $save_result; ?></h2> <span class="d-none d-sm-inline"></span></a>
                </div>
                <div>
        ...
        <div class="col py-3">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="display:inline;">
                ...
                <br>
                <div class="col-auto">
                    <input type="submit" id="search" name="search" class="btn btn-success" value="搜  尋">&ensp;&ensp;&ensp;
                ...
                <div id="read" class="row g-3">
                    ...
                    <div class="col-auto">
                    <input type="submit" id="checkin_x" name="checkin" class="btn btn-success" style="font-size:36px;" value="報   到">
